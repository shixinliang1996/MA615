...
get_top3 <- function(x, y){
  mod_mean <- tapply(x, y, mean) 
  ind <- order(mod_mean)
  miles <- rev(mod_mean[ind])
  result <- round(miles, 2)
  return(result)
}

miles_cty_99 <- get_top3(mpg$cty[mpg$year=='1999'],mpg$model[mpg$year=='1999'])
miles_cty_08 <- get_top3(mpg$cty[mpg$year=='2008'],mpg$model[mpg$year=='2008'])
miles_hwy_99 <- get_top3(mpg$hwy[mpg$year=='1999'],mpg$model[mpg$year=='1999'])
miles_hwy_08 <- get_top3(mpg$hwy[mpg$year=='2008'],mpg$model[mpg$year=='2008'])
